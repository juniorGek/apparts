...
?>
                        ...
                        <div class="panel-body"></div>
                                    <form class="form-horizontal" action="/imm/traitement/tr_rech_im.php" method="POST">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="email">Recherche:</label>
                                            <div class="col-sm-10 col-lg-4">
                                            <input type="search" class="form-control" name="rech" placeholder="saisir l'immeuble a chercher" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
